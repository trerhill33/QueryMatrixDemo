...
namespace QueryMatrixDemo.Core.Core.Helpers;

/// <summary>
/// Provides utility methods for building complex LINQ expressions, including string comparisons and IN operations, optimizing performance through method caching.
/// </summary>
internal static class ExpressionBuilder
{
    ...
    private static readonly MethodInfo ToLowerInvariantMethod = typeof(string).GetMethod("ToLowerInvariant", Type.EmptyTypes)!;
